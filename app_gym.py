...
if opcion == "🆕 Registrar Nuevo Cliente":
    ...
    with st.form("form_nuevo_cliente", clear_on_submit=True):
        ...
        whatsapp = st.text_input("Número de WhatsApp (10 dígitos, ej: 322xxxxxxx):").strip()
    ...
    if not df_clientes.empty:
        ...
        if not clientes_alerta.empty:
            ...
            for idx, fila in clientes_alerta.iterrows():
                ...
                texto_base = f"Hola {fila['nombre_completo']}, te saludamos de tu Gym 🏋️‍♂️. Te recordamos que tu mensualidad presenta un estado {estado} con fecha de corte el {fila['fecha_vencimiento']}. ¡Te esperamos para seguir entrenando juntos!"
